...
:-: | :-: | :-: | :-: | :-: | :-: | :-:
[Nodegraphs List](https://github.com/Berymuch/Streamer.Bot/blob/main/Chat%20Commands%20List.md) | [Dropables](https://github.com/Berymuch/Streamer.Bot/blob/main/Actions%20List.md) | [Edibles](https://github.com/Berymuch/Streamer.Bot/blob/main/Botymuch%20OBS%20source%20setup.md) | [Objects](https://github.com/Berymuch/Streamer.Bot/blob/main/Streamerbot%20SFX.zip) | [Sounds](https://github.com/Berymuch/Streamer.Bot/blob/main/shoutouthd.html) | [Throwables](https://github.com/Berymuch/Streamer.Bot/blob/main/Botymuch%20Streaming%20Layout.streamDeckProfile) | [Bubbles](https://github.com/Berymuch/Streamer.Bot/blob/main/Botymuch%20Streaming%20Layout.streamDeckProfile)

>*There's A LOT here to unpack- graphs cover things from automation tasks, to user redeems, chat commands, model effects and swapping, and so much more. The vast majority of these nodes will not work out of the box and rely on specific asset files that were not created by me and that I cannot share directly...however, they do give a good idea of the logic required to make everything work. I'm in the process of documenting everything that's happening here, and it remains under active development. Check back infrequently to grab the latest updates and bug fixes!*
