...
Kodai Ryu Flaming Book Nut | 🟩 | 🟩 | | This will drop the specified droppable after the delay and play an SFX when the object hits while also randomize another SFX from 5 possible outcomes.
